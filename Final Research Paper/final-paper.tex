...
We therefore impose two sampling constraints. First, we filter to articles whose
titles explicitly contain the company name and de-duplicate by normalized title
per company. Second, we apply a minimum annual coverage threshold: a company is
retained if it has at most three years with $\leq 3{,}000$ articles; companies
failing this are dropped. Table~\ref{tab:pipeline} shows the full construction
funnel from raw panel to analysis sample.
...
\begin{tabular}{lrr}
\toprule
Stage & Firms & Firm-article links \\
\midrule
Raw panel (2015--2025)              & 30 & 4,706,589 \\
\quad Title deduplication           & 30 & --- \\
\quad Coverage filter ($\leq$3 sparse years) & 22 & --- \\
Final stratified panel              & 22 & 483,514 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{article_count_distribution.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{top_20_articles.png}}
